...
RESULTS_DIR = Path(__file__).resolve().parent.parent / "results" / "submissions" / "v18"
...
def main() -> None:
    ...
    print(f"\n Post-processing complete: {scaled_path.name}")
    ...
    # Chỉ lấy bản alpha = 0.22 (Bản tốt nhất để làm anchor)
    alpha = 0.22
    out = out_raw.copy()
    ...
    outputs[f"submission_v18_dl_stack_anchor_a22.csv"] = out
